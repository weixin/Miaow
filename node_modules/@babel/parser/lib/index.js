...
var typescript = (function (superClass) {
  return function (_superClass) {
    ...
    _proto.tsTryParseTypeArgumentsInExpression = function tsTryParseTypeArgumentsInExpression(eatNextToken) {
      var _this7 = this;

      return this.tsTryParseAndCatch(function () {
        var res = _this7.tsParseTypeArguments();

        if (eatNextToken) _this7.expect(types.parenL);
        return res;
      });
    };
    ...
    _proto.parseSubscript = function parseSubscript(base, startPos, startLoc, noCalls, state) {
      ...
      if (!noCalls && this.isRelational("<")) {
        ...
        var node = this.startNodeAt(startPos, startLoc);
        node.callee = base;
        var typeArguments = this.tsTryParseTypeArgumentsInExpression(true);
    ...
    _proto.jsxParseOpeningElementAfterName = function jsxParseOpeningElementAfterName(node) {
      var typeArguments = this.tsTryParseTypeArgumentsInExpression(false);
