...
/*!*********************!*\
  !*** ./src/flag.js ***!
  \*********************/
/*! exports provided: getFlag, markAction */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFlag", function() { return getFlag; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "markAction", function() { return markAction; });
...
/*!*********************!*\
  !*** ./src/link.js ***!
  \*********************/
/*! exports provided: getLink, linkAction */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getLink", function() { return getLink; });
...
function toolSettingAction(context) {
  ...
  var i18t = Object(_common__WEBPACK_IMPORTED_MODULE_0__["_"])(context).toolSetting;
  ...
  flowIndicatorOptionsView.addSubview(flowIndicatorColorWell); // 添加箭头线粗细  

  var flowIndicatorThicknessWell = NSTextField.alloc().initWithFrame(NSMakeRect(105, 0, 44, 23)); // 读取系统默认的粗细

  var flowIndicatorThicknessNum = NSUserDefaults.standardUserDefaults().objectForKey(lineThicknessKey) || "6"; // // 默认值填入输入框

  flowIndicatorThicknessWell.setStringValue(flowIndicatorThicknessNum); // 将文本输入框放在 NSView 中
  ...
  if (response == "1000") {
    ...
    NSUserDefaults.standardUserDefaults().setObject_forKey(flowIndicatorColor2, flagColorKey); // 获取 “箭头线粗细” 输入框的值，存入 系统key 中
    ...
    Object(_link__WEBPACK_IMPORTED_MODULE_1__["getLink"])(nowContext, true);
    Object(_flag__WEBPACK_IMPORTED_MODULE_2__["getFlag"])(context, true);
