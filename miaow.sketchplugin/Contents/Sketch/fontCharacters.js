...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/fontCharacters.js");
/******/ })
/************************************************************************/
/******/ ({
...
var fontCharacters = function fontCharacters(context) {
  var i18 = Object(_common__WEBPACK_IMPORTED_MODULE_0__["_"])(context).fontCharacters;
  ...
  Object(_common__WEBPACK_IMPORTED_MODULE_0__["SMPanel"])({
    ...
    pushdataCallback: function pushdataCallback(data, windowObject) {
      if (data.action == 'insert') {
        ...
        var fontfamily = NSFont.fontWithName_fontFamily(data.fontFamily, 14);
        ...
        if (layer.class() == 'MSTextLayer') {
          ...
          Object(_common__WEBPACK_IMPORTED_MODULE_0__["errorDialog"])(context, i18.m1);
        }

        windowObject.evaluateWebScript("window.location.hash = '';");
      } else {
        NSUserDefaults.standardUserDefaults().setObject_forKey(data.fontFamily, FontSetKey);
        var font = NSFont.fontWithName_size(data.fontFamily, 14.0);
